...
public:
	...
	struct FScriptDelegate                             AtPanicDelegate;                                          // 0x01A0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData07[0x4];                                       // 0x0199(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData08[0x10];                                      // 0x01B0(0x0010) MISSED OFFSET
	struct FScriptDelegate                             CodeFinishDelegate;                                       // 0x01C0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData09[0x4];                                       // 0x01B0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             CodeOutputDelegate;                                       // 0x01D0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData10[0x4];                                       // 0x01D0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             HasEventToRunDelegate;                                    // 0x01E0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData11[0x4];                                       // 0x01E0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             PrepareEventDelegate;                                     // 0x01F0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData12[0x4];                                       // 0x01F0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             ExecuteDelayedDelegate;                                   // 0x0200(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData13[0x4];                                       // 0x0200(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             CodePreExecuteDelegate;                                   // 0x0210(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData14[0x4];                                       // 0x0210(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData15[0x20];                                      // 0x0220(0x0020) MISSED OFFSET
	...
	unsigned char                                      UnknownData16[0xF0];                                      // 0x0270(0x00F0) MISSED OFFSET
