...
public:
	...
	static bool IsRoleOK(EBuffEnabledRole EnabledRole, class UActorComponent* OwnerComponent);
};
...
public:
	...
	TArray<class USTBuffTriggerBase*>                  TriggerBases;                                             // 0x0098(0x0010) (Edit, BlueprintVisible, ExportObject, ZeroConstructor)
	...
	void Tick(class UActorComponent* BuffSystemComponent, int InstID, float DetalTime, float TimeSeconds, TArray<int>* TickActionList);
	...
	bool ChangeNotify(class UActorComponent* BuffSystemComponent, int InstID);
};
...
public:
	...
	bool                                               bEnableTick;                                              // 0x0088(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0089(0x0003) MISSED OFFSET
	float                                              Interval;                                                 // 0x008C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FirstTickStartTime;                                       // 0x0090(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bTickByPeriod;                                            // 0x0094(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               AutoEnabled;                                              // 0x0095(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x2];                                       // 0x0096(0x0002) MISSED OFFSET
	TArray<class UObject*>                             CacheSoftObject;                                          // 0x0098(0x0010) (ZeroConstructor)
	...
	void Tick2(class UActorComponent* BuffSystemComponent, int InstID, float DetalTime);
	...
	bool IsRoleOK(class UActorComponent* OwnerComponent);
	void Initialize(class UActorComponent* BuffSystemComponent, int InstID);
...
public:
	...
	TMap<struct FString, struct FString>               ActionParams;                                             // 0x0118(0x0050) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
{
public:
	class USTBuffCondition*                            Condition;                                                // 0x00A8(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	float                                              ConditionTickInterval;                                    // 0x00B0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              Probality;                                                // 0x00B4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EBuffConditionExecuteTimeType                      ExecuteTimeType;                                          // 0x00B8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsDoOnFalse;                                              // 0x00B9(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsNeedTick;                                               // 0x00BA(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsNeedExecute;                                            // 0x00BB(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsSetFalseWhenExecute;                                    // 0x00BC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00BD(0x0003) MISSED OFFSET
	TArray<struct FBuffConditionActionItem>            LinkActions;                                              // 0x00C0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
...
public:
	unsigned char                                      UnknownData00[0x20];                                      // 0x0028(0x0020) MISSED OFFSET
	class USTBuffNodeInstanceData*                     OwnerInstanceData;                                        // 0x0048(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class USTBuffEvent*                                OwnerEvent;                                               // 0x0050(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	EBuffEnabledRole                                   ExecuteRole;                                              // 0x0058(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bStateEvent;                                              // 0x0059(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x6];                                       // 0x005A(0x0006) MISSED OFFSET
	struct FString                                     StateSharedKey;                                           // 0x0060(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
...
public:
	...
	TMap<struct FString, struct FString>               ActionParams;                                             // 0x0130(0x0050) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	bool                                               bEnableLuaPrivateData;                                    // 0x0180(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	TArray<class USTBuffEvent*>                        Events;                                                   // 0x0070(0x0010) (Edit, BlueprintVisible, ExportObject, ZeroConstructor)
...
// Class Basic.STBuffTriggerBase
// 0x0018 (0x0070 - 0x0058)
class USTBuffTriggerBase : public USTBuffNodeInstanceData
{
public:
	EBuffEnabledRole                                   ExecuteRole;                                              // 0x0058(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0059(0x0007) MISSED OFFSET
	struct FTriggerConditionConfig                     ConditionConfig;                                          // 0x0060(0x0010) (Edit, BlueprintVisible)

	static UClass* StaticClass()
	{
        static UClass *pStaticClass = 0;
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("Class Basic.STBuffTriggerBase");
		return pStaticClass;
	}


	void Tick(class UActorComponent* BuffSystemComponent, int InstID, float DeltaTime);
...
// Class Basic.STBuffTrigger_Event
// 0x0008 (0x0078 - 0x0070)
class USTBuffTrigger_Event : public USTBuffTriggerBase
{
public:
	class USTBuffEvent*                                Event;                                                    // 0x0070(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)

	static UClass* StaticClass()
	{
        static UClass *pStaticClass = 0;
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("Class Basic.STBuffTrigger_Event");
		return pStaticClass;
	}
...
// Class Basic.STBuffTrigger_OnAdd
// 0x0000 (0x0070 - 0x0070)
class USTBuffTrigger_OnAdd : public USTBuffTriggerBase
{
public:
	...
	static UClass* StaticClass()
	{
        static UClass *pStaticClass = 0;
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("Class Basic.STBuffTrigger_OnAdd");
		return pStaticClass;
	}
...
// Class Basic.STBuffTrigger_Timer
// 0x0008 (0x0078 - 0x0070)
class USTBuffTrigger_Timer : public USTBuffTriggerBase
{
public:
	float                                              TickInterval;                                             // 0x0070(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bTriggerOnAdd;                                            // 0x0074(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	static UClass* StaticClass()
	{
        static UClass *pStaticClass = 0;
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("Class Basic.STBuffTrigger_Timer");
		return pStaticClass;
	}
...
{
public:
	unsigned char                                      UnknownData00[0x50];                                      // 0x1280(0x0050) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData06[0x100];                                     // 0x0648(0x0100) MISSED OFFSET
