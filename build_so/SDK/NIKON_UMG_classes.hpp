...
// Telegram:- @Manish8x
// GEN ONWed May 20 07:23:17 2026
...
public:
	...
	struct FScriptDelegate                             bIsEnabledDelegate;                                       // 0x0030(0x000C) (ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             ToolTipTextDelegate;                                      // 0x0058(0x000C) (ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             ToolTipWidgetDelegate;                                    // 0x0070(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0070(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             VisibilityDelegate;                                       // 0x0080(0x000C) (ZeroConstructor, InstancedReference)
	...
	TEnumAsByte<enum EMouseCursor>                     Cursor;                                                   // 0x00B8(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData05[0x28];                                      // 0x00C8(0x0028) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             ColorAndOpacityDelegate;                                  // 0x0118(0x000C) (ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             ForegroundColorDelegate;                                  // 0x0150(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0150(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	struct FScriptDelegate                             OnTouchStart;                                             // 0x01A0(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData03[0x4];                                       // 0x01A0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnTouchMove;                                              // 0x01B0(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData04[0x4];                                       // 0x01B0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnTouchEnd;                                               // 0x01C0(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData05[0x4];                                       // 0x01C0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData06 : 1;                                        // 0x01EC(0x0001)
	...
	unsigned char                                      UnknownData07[0x7];                                       // 0x0201(0x0007) MISSED OFFSET
...
public:
	...
	bool                                               AutoCapitalizeText;                                       // 0x0140(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0141(0x0007) MISSED OFFSET
	struct FScriptDelegate                             TextDelegate;                                             // 0x0148(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0141(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	TArray<struct FSlateColor>                         ColorSwitchList;                                          // 0x0158(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                ActiveColorIndex;                                         // 0x0168(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x016C(0x0004) MISSED OFFSET
	TArray<struct FString>                             ColorDesList;                                             // 0x0170(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	struct FSlateColor                                 ColorAndOpacity;                                          // 0x0180(0x0028) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FScriptDelegate                             ColorAndOpacityDelegate;                                  // 0x01A8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData03[0x4];                                       // 0x01A8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FSlateColor                                 SelectColorAndOpacity;                                    // 0x01B8(0x0028) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FSlateColor                                 NoSelectColorAndOpacity;                                  // 0x01E0(0x0028) (Edit, BlueprintVisible, BlueprintReadOnly)
	bool                                               bHaveSelectColorAndOpacity;                               // 0x0208(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bIsSelected;                                              // 0x0209(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x6];                                       // 0x020A(0x0006) MISSED OFFSET
	struct FSlateFontInfo                              Font;                                                     // 0x0210(0x0058) (Edit, BlueprintVisible, BlueprintReadOnly)
	...
	struct FScriptDelegate                             ShadowColorAndOpacityDelegate;                            // 0x0280(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData05[0x4];                                       // 0x0280(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	float                                              MinDesiredWidth;                                          // 0x0290(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               AutoEllipsisText;                                         // 0x0294(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bWrapWithInvalidationPanel;                               // 0x0295(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x12];                                      // 0x0296(0x0012) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             OnGenerateWidgetEvent;                                    // 0x0FC0(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0FBA(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData03[0x20];                                      // 0x0FD0(0x0020) MISSED OFFSET
	...
	unsigned char                                      UnknownData04[0x50];                                      // 0x1020(0x0050) MISSED OFFSET
...
{
public:
	class UClass*                                      WidgetClass;                                              // 0x09A0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   DrawSize;                                                 // 0x09A8(0x0008) (Edit, IsPlainOldData)
	bool                                               bManuallyRedraw;                                          // 0x09B0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bRedrawRequested;                                         // 0x09B1(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x09B2(0x0002) MISSED OFFSET
	float                                              RedrawTime;                                               // 0x09B4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                                       // 0x09B8(0x0008) MISSED OFFSET
	struct FIntPoint                                   CurrentDrawSize;                                          // 0x09C0(0x0008) (IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x09C8(0x0004) MISSED OFFSET
	bool                                               bDrawAtDesiredSize;                                       // 0x09CC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x09CD(0x0003) MISSED OFFSET
	struct FVector2D                                   Pivot;                                                    // 0x09D0(0x0008) (Edit, IsPlainOldData)
	bool                                               bReceiveHardwareInput;                                    // 0x09D8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bWindowFocusable;                                         // 0x09D9(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x6];                                       // 0x09DA(0x0006) MISSED OFFSET
	class ULocalPlayer*                                OwnerPlayer;                                              // 0x09E0(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                BackgroundColor;                                          // 0x09E8(0x0010) (Edit, IsPlainOldData)
	struct FLinearColor                                TintColorAndOpacity;                                      // 0x09F8(0x0010) (Edit, IsPlainOldData)
	float                                              OpacityFromTexture;                                       // 0x0A08(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EWidgetBlendMode                                   BlendMode;                                                // 0x0A0C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bIsTwoSided;                                              // 0x0A0D(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               TickWhenOffscreen;                                        // 0x0A0E(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x1];                                       // 0x0A0F(0x0001) MISSED OFFSET
	class UUserWidget*                                 Widget;                                                   // 0x0A10(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, DuplicateTransient, IsPlainOldData)
	unsigned char                                      UnknownData06[0x20];                                      // 0x0A18(0x0020) MISSED OFFSET
	class UBodySetup*                                  BodySetup;                                                // 0x0A38(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterialAA;                                    // 0x0A40(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterialAA_OneSided;                           // 0x0A48(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterial;                                      // 0x0A50(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterial_OneSided;                             // 0x0A58(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          OpaqueMaterial;                                           // 0x0A60(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          OpaqueMaterial_OneSided;                                  // 0x0A68(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          MaskedMaterial;                                           // 0x0A70(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          MaskedMaterial_OneSided;                                  // 0x0A78(0x0008) (ZeroConstructor, IsPlainOldData)
	class UTextureRenderTarget2D*                      RenderTarget;                                             // 0x0A80(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	class UMaterialInstanceDynamic*                    MaterialInstance;                                         // 0x0A88(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               bAddedToScreen;                                           // 0x0A90(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               bEditTimeUsable;                                          // 0x0A91(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x6];                                       // 0x0A92(0x0006) MISSED OFFSET
	struct FName                                       SharedLayerName;                                          // 0x0A98(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                LayerZOrder;                                              // 0x0AA0(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	EWidgetGeometryMode                                GeometryMode;                                             // 0x0AA4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x3];                                       // 0x0AA5(0x0003) MISSED OFFSET
	float                                              CylinderArcAngle;                                         // 0x0AA8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x54];                                      // 0x0AAC(0x0054) MISSED OFFSET
	bool                                               ForceDisableShareRT;                                      // 0x0B00(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0xF];                                       // 0x0B01(0x000F) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             ValueDelegate;                                            // 0x0108(0x000C) (ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             OnMouseButtonDownEvent;                                   // 0x04E8(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x4];                                       // 0x04E8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	EButtonOnClickSound                                OnClickSoundType;                                         // 0x04F8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x1F];                                      // 0x04F9(0x001F) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             TextDelegate;                                             // 0x0118(0x000C) (ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             HintTextDelegate;                                         // 0x0BC0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0BC0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData04[0x2];                                       // 0x0C5A(0x0002) MISSED OFFSET
	...
	unsigned char                                      UnknownData05[0x1];                                       // 0x0C77(0x0001) MISSED OFFSET
	...
	unsigned char                                      UnknownData06[0x3];                                       // 0x0C7D(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownData07[0x10];                                      // 0x0CA0(0x0010) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             BrushDelegate;                                            // 0x01B8(0x000C) (ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             OnSetBrushAsyncComplete;                                  // 0x01D0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x01C9(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	TArray<struct FSlateColor>                         ColorSwitchList;                                          // 0x01E0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                ActiveColorIndex;                                         // 0x01F0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x01F4(0x0004) MISSED OFFSET
	TArray<struct FString>                             ColorDesList;                                             // 0x01F8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	struct FLinearColor                                ColorAndOpacity;                                          // 0x0208(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	struct FScriptDelegate                             ColorAndOpacityDelegate;                                  // 0x0218(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData04[0x4];                                       // 0x0218(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FString                                     imageSrcPath;                                             // 0x0228(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	struct FVector2D                                   ScalePivot;                                               // 0x0238(0x0008) (Edit, IsPlainOldData)
	struct FScriptDelegate                             OnMouseButtonDownEvent;                                   // 0x0240(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData05[0x4];                                       // 0x0240(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FSoftObjectPath                             AsyncLoadResourcePath;                                    // 0x0250(0x0018)
	unsigned char                                      UnknownData06[0x20];                                      // 0x0268(0x0020) MISSED OFFSET
	float                                              HitTestAreaRadius;                                        // 0x0288(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIsEnhancedImage;                                         // 0x028C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bIsUseEnhancedHitTest;                                    // 0x028D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bFixOverScale;                                            // 0x028E(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bVersionImg;                                              // 0x028F(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bDontPaintWhenAlphaZero;                                  // 0x0290(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bDontPaintWhenColorZero;                                  // 0x0291(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bAsyncLoadImageAsset;                                     // 0x0292(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bDisablePixelSnapping;                                    // 0x0293(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	void SetBrushFromSoftObjectPathAsync(const struct FSoftObjectPath& SoftObjectPath, bool bMatchSize);
...
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0118(0x0010) MISSED OFFSET
	struct FScriptDelegate                             ContentColorAndOpacityDelegate;                           // 0x0128(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0118(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	struct FScriptDelegate                             BackgroundDelegate;                                       // 0x0200(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0200(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FLinearColor                                BrushColor;                                               // 0x0210(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	struct FScriptDelegate                             BrushColorDelegate;                                       // 0x0220(0x000C) (ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             OnMouseButtonDownEvent;                                   // 0x0238(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData04[0x4];                                       // 0x0238(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnMouseButtonUpEvent;                                     // 0x0248(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData05[0x4];                                       // 0x0248(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnMouseMoveEvent;                                         // 0x0258(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData06[0x4];                                       // 0x0258(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnMouseDoubleClickEvent;                                  // 0x0268(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData07[0x4];                                       // 0x0268(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData08[0x16];                                      // 0x027A(0x0016) MISSED OFFSET
...
{
public:
	struct FScriptDelegate                             CheckedStateDelegate;                                     // 0x0118(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0118(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData04[0x10];                                      // 0x0900(0x0010) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             OnGenerateWidgetEvent;                                    // 0x0110(0x000C) (Edit, ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             HintTextDelegate;                                         // 0x0140(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0140(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	TArray<struct FSlateColor>                         ColorSwitchList;                                          // 0x0150(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                ActiveColorIndex;                                         // 0x0160(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0164(0x0004) MISSED OFFSET
	TArray<struct FString>                             ColorDesList;                                             // 0x0168(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	struct FEditableTextStyle                          WidgetStyle;                                              // 0x0178(0x02B0) (Edit, BlueprintVisible)
	...
	class USlateBrushAsset*                            BackgroundImageComposing;                                 // 0x0438(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	class USlateBrushAsset*                            CaretImage;                                               // 0x0440(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FSlateFontInfo                              Font;                                                     // 0x0448(0x0058) (Deprecated)
	struct FSlateColor                                 ColorAndOpacity;                                          // 0x04A0(0x0028) (Deprecated)
	bool                                               IsReadOnly;                                               // 0x04C8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               IsPassword;                                               // 0x04C9(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x2];                                       // 0x04CA(0x0002) MISSED OFFSET
	float                                              MinimumDesiredWidth;                                      // 0x04CC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               IsCaretMovedWhenGainFocus;                                // 0x04D0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               SelectAllTextWhenFocused;                                 // 0x04D1(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               RevertTextOnEscape;                                       // 0x04D2(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               ClearKeyboardFocusOnCommit;                               // 0x04D3(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               SelectAllTextOnCommit;                                    // 0x04D4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               AllowContextMenu;                                         // 0x04D5(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum EVirtualKeyboardType>             KeyboardType;                                             // 0x04D6(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x1];                                       // 0x04D7(0x0001) MISSED OFFSET
	struct FShapedTextOptions                          ShapedTextOptions;                                        // 0x04D8(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly)
	bool                                               bVirtualKeyboardTriggerDirect;                            // 0x04DC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x3];                                       // 0x04DD(0x0003) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnTextChanged;                                            // 0x04E0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnTextCommitted;                                          // 0x04F0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	struct FScriptDelegate                             OnGenerateRowEvent;                                       // 0x0120(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0119(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	struct FScriptDelegate                             OnGetMenuContentEvent;                                    // 0x0120(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0120(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
// 0x0350 (0x0478 - 0x0128)
class UMultiLineEditableText : public UTextLayoutWidget
{
public:
	struct FText                                       Text;                                                     // 0x0128(0x0018) (Edit)
	struct FText                                       HintText;                                                 // 0x0140(0x0018) (Edit)
	struct FScriptDelegate                             HintTextDelegate;                                         // 0x0158(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0158(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	TArray<struct FSlateColor>                         ColorSwitchList;                                          // 0x0168(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                ActiveColorIndex;                                         // 0x0178(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x017C(0x0004) MISSED OFFSET
	TArray<struct FString>                             ColorDesList;                                             // 0x0180(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	struct FTextBlockStyle                             WidgetStyle;                                              // 0x0190(0x0250) (Edit, BlueprintVisible)
	bool                                               bIsReadOnly;                                              // 0x03E0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x03E1(0x0007) MISSED OFFSET
	struct FSlateFontInfo                              Font;                                                     // 0x03E8(0x0058) (Deprecated)
	bool                                               AllowContextMenu;                                         // 0x0440(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x7];                                       // 0x0441(0x0007) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnTextChanged;                                            // 0x0448(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnTextCommitted;                                          // 0x0458(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData04[0x10];                                      // 0x0468(0x0010) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData02[0x10];                                      // 0x0ED8(0x0010) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             PercentDelegate;                                          // 0x0360(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0360(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FLinearColor                                FillColorAndOpacity;                                      // 0x0370(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	struct FScriptDelegate                             FillColorAndOpacityDelegate;                              // 0x0380(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0380(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	struct FText                                       Text;                                                     // 0x0128(0x0018) (Edit)
	struct FScriptDelegate                             TextDelegate;                                             // 0x0140(0x000C) (ZeroConstructor, InstancedReference)
	...
	unsigned char                                      UnknownData01[0x260];                                     // 0x01C8(0x0260) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData05[0x14];                                      // 0x05E4(0x0014) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             OnGenerateTileEvent;                                      // 0x0120(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0119(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
public:
	struct FScriptMulticastDelegate                    OnAnimationStarted;                                       // 0x02E8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnAnimationFinished;                                      // 0x02F8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	class UMovieScene*                                 MovieScene;                                               // 0x0308(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	TArray<struct FWidgetAnimationBinding>             AnimationBindings;                                        // 0x0310(0x0010) (ZeroConstructor)
...
public:
	...
	unsigned char                                      bAllowTemplate : 1;                                       // 0x0350(0x0001)
	unsigned char                                      bValidTemplate : 1;                                       // 0x0350(0x0001)
	unsigned char                                      bTemplateInitialized : 1;                                 // 0x0350(0x0001) (Transient)
	unsigned char                                      bCookedTemplate : 1;                                      // 0x0350(0x0001) (Transient)
	unsigned char                                      bClassRequiresNativeTick : 1;                             // 0x0350(0x0001)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0351(0x0007) MISSED OFFSET
	TArray<struct FDelegateRuntimeBinding>             Bindings;                                                 // 0x0358(0x0010) (ZeroConstructor)
	TArray<class UWidgetAnimation*>                    Animations;                                               // 0x0368(0x0010) (ExportObject, ZeroConstructor)
	TArray<struct FName>                               NamedSlots;                                               // 0x0378(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x28];                                      // 0x0388(0x0028) UNKNOWN PROPERTY: SoftObjectProperty UMG.WidgetBlueprintGeneratedClass.TemplateAsset
	class UUserWidget*                                 Template;                                                 // 0x03B0(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
...
public:
	...
	TEnumAsByte<enum ECollisionChannel>                TraceChannel;                                             // 0x03C8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
