...
public:
	...
	float Func3();
	void Func29(class UWorld* World, const struct FBulletHitInfoUploadDataInReplay& HitData, float DrawRadius, float DisplayTime, bool bDrawVictimBound);
...
public:
	...
	unsigned char                                      UnknownData16[0x30];                                      // 0x10DC(0x0030) MISSED OFFSET
	float                                              OfflineMoveThreshold;                                     // 0x110C(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              OfflineMoveValidScale;                                    // 0x1110(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              LongTimeNoReceiveScale;                                   // 0x1114(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                MinOfflineCount;                                          // 0x1118(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                MaxOfflineCount;                                          // 0x111C(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bOfflineMoveReady;                                        // 0x1120(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData17[0x27];                                      // 0x1121(0x0027) MISSED OFFSET
...
// Class HiggsBoson.HiggsBosonScriptHelper
// 0x0000 (0x0028 - 0x0028)
class UHiggsBosonScriptHelper : public UObject
{
public:
	...
	static UClass* StaticClass()
	{
        static UClass *pStaticClass = 0;
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("Class HiggsBoson.HiggsBosonScriptHelper");
		return pStaticClass;
	}


	static void FileCRCGuard_UnregisterFile(const struct FString& InFilePath);
	static bool FileCRCGuard_RegisterFile(const struct FString& InFilePath, const struct FString& InTag);
};
