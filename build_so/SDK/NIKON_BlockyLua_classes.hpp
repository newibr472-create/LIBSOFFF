...
public:
	...
	struct FScriptDelegate                             OnAsyncLoadBinCompletedHandle;                            // 0x02E0(0x000C) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x02DA(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
