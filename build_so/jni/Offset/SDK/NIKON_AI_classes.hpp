...
public:
	...
	void DoActionQuickMark_MLAI(int actorUID, int ItemId, int CheckRange);
...
public:
	...
	struct FScriptDelegate                             GetDynamicItemDurabilityDelegate;                         // 0x0248(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0248(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData03[0x10];                                      // 0x02C8(0x0010) MISSED OFFSET
	...
	bool                                               bIsDestructibleItem;                                      // 0x02DD(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseMeshMapping;                                          // 0x02DE(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x79];                                      // 0x02DF(0x0079) MISSED OFFSET
	class UPhotonDestructibleMeshComponent*            CachedDestructComp;                                       // 0x0358(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData05[0x8];                                       // 0x0360(0x0008) MISSED OFFSET
...
public:
	...
	class ASTExtraBaseCharacter* GetOwnerBaseCharacter();
	void GetNearbyItemState(class ASTExtraBaseCharacter* InPawn, bool* OutIsUseCacheItem, TArray<struct FItemStateData>* NearbyItems);
	uint32_t GetFrameNo();
...
// Class AI.BTDecorator_CheckEnvironment
// 0x0030 (0x0090 - 0x0060)
class UBTDecorator_CheckEnvironment : public UBTDecorator
{
public:
	struct FBlackboardKeySelector                      BBKTarget;                                                // 0x0060(0x0028) (Edit)
	bool                                               bCheckInWater;                                            // 0x0088(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bCheckInHouse;                                            // 0x0089(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	static UClass* StaticClass()
	{
        static UClass *pStaticClass = 0;
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("Class AI.BTDecorator_CheckEnvironment");
		return pStaticClass;
	}
...
public:
	...
	struct FBlackboardKeySelector                      BBKey_OutCannotReach;                                     // 0x00F0(0x0028) (Edit, BlueprintVisible)
	float                                              MaxExecutionDuration;                                     // 0x0118(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsCheckStuckUseMovePenetration;                           // 0x011C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x011D(0x0003) MISSED OFFSET
	int                                                MoveStuckFrameCount;                                      // 0x0120(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0124(0x0004) MISSED OFFSET
	class ABioVehicleBase*                             BioVH;                                                    // 0x0128(0x0008) (ZeroConstructor, IsPlainOldData)
	class ABioVehicleAIController*                     BioVHAIC;                                                 // 0x0130(0x0008) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	bool                                               bUsePhysRotate;                                           // 0x00A0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00A1(0x0003) MISSED OFFSET
	float                                              MaxExecuteTime;                                           // 0x00A4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
...
// Class AI.MercenaryAICharacterBase
// 0x0020 (0x7270 - 0x7250)
class AMercenaryAICharacterBase : public ASTExtraPlayerCharacter
{
public:
	bool                                               bShouldUseGameModeNetCullingDist;                         // 0x7250(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x7251(0x0003) MISSED OFFSET
	float                                              AttachedActorFoldWeaponMaxAngle;                          // 0x7254(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              AttachedPlayerHeightOffset;                               // 0x7258(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     GrenadeThrowOffset;                                       // 0x725C(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                                       // 0x7268(0x0008) MISSED OFFSET

	static UClass* StaticClass()
	{
        static UClass *pStaticClass = 0;
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("Class AI.MercenaryAICharacterBase");
		return pStaticClass;
	}
...
// Class AI.MercenaryJumpObstacleInfoCollector
// 0x01F8 (0x0250 - 0x0058)
class UMercenaryJumpObstacleInfoCollector : public UStateInfoCollectorBase
{
public:
	TMap<uint32_t, struct FMercenaryJumpObstacleAIStateInfo> LastAllPlayerStateInfoMap;                                // 0x0058(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FMercenaryJumpObstacleAIStateInfo> CurrentAllPlayerStateInfoMap;                             // 0x00A8(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FMercenaryJumpObstacleAIStateInfo> CacheAllPlayersInfo;                                      // 0x00F8(0x0050) (ZeroConstructor)
	struct FDiffMercenaryJumpObstacleAllPlayerInfo     CacheDiffAllPlayersInfoGeneral;                           // 0x0148(0x0108)

	static UClass* StaticClass()
	{
        static UClass *pStaticClass = 0;
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("Class AI.MercenaryJumpObstacleInfoCollector");
		return pStaticClass;
	}
...
// Class AI.MercenaryPassengerCameraModifierBase
// 0x0070 (0x00B8 - 0x0048)
class UMercenaryPassengerCameraModifierBase : public UCameraModifier
{
public:
	unsigned char                                      UnknownData00[0x4];                                       // 0x0048(0x0004) MISSED OFFSET
	struct FPassengerCameraViewLimit                   TppViewLimit;                                             // 0x004C(0x0024) (Edit, DisableEditOnInstance)
	struct FPassengerCameraViewLimit                   FppViewLimit;                                             // 0x0070(0x0024) (Edit, DisableEditOnInstance)
	struct FPassengerCameraViewLimit                   BowViewLimit;                                             // 0x0094(0x0024) (Edit, DisableEditOnInstance)

	static UClass* StaticClass()
	{
        static UClass *pStaticClass = 0;
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("Class AI.MercenaryPassengerCameraModifierBase");
		return pStaticClass;
	}
...
// Class AI.MLAIDestructibleInfoCollector
// 0x0330 (0x0388 - 0x0058)
class UMLAIDestructibleInfoCollector : public UStateInfoCollectorBase
{
public:
	TMap<uint32_t, struct FDestructibleItemAIStateInfo> LastAllPlayerStateInfoMap;                                // 0x0058(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDestructibleItemAIStateInfo> CurrentAllPlayerStateInfoMap;                             // 0x00A8(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDestructibleItemAIStateInfo> CacheAllPlayersInfo;                                      // 0x00F8(0x0050) (ZeroConstructor)
	struct FDiffDestructibleItemAllPlayersInfo         CacheDiffAllPlayersInfoGeneral;                           // 0x0148(0x0108)
	struct FDestructibleItemGlobalGameState            CacheGlobalGameState;                                     // 0x0250(0x0040)
	struct FDestructibleItemGlobalGameState            LastGlobalGameState;                                      // 0x0290(0x0040)
	struct FDiffDestructibleItemGlobalGameState        DiffGlobalGameStateGeneral;                               // 0x02D0(0x0068)
	TMap<uint64_t, struct FDestructibleItem>           CacheDestructibleItems;                                   // 0x0338(0x0050) (ZeroConstructor)

	static UClass* StaticClass()
	{
        static UClass *pStaticClass = 0;
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("Class AI.MLAIDestructibleInfoCollector");
		return pStaticClass;
	}
...
public:
	...
	int                                                OverrideMapID;                                            // 0x07C0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x4];                                       // 0x07C4(0x0004) MISSED OFFSET
	unsigned char                                      UnknownData07[0x50];                                      // 0x07C4(0x0050) UNKNOWN PROPERTY: SetProperty AI.MLAISubSystem.TeammateMLAITeamIDSet
	TArray<uint32_t>                                   SilentMLAIList;                                           // 0x0818(0x0010) (ZeroConstructor)
	bool                                               WhitelistPlayerStatesSwitch;                              // 0x0828(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x7];                                       // 0x0829(0x0007) MISSED OFFSET
	TArray<uint32_t>                                   PlayerWhitelist;                                          // 0x0830(0x0010) (ZeroConstructor)
	TMap<class APawn*, class APawn*>                   PlayerWhiteMercenary2MasterMap;                           // 0x0840(0x0050) (ZeroConstructor)
	bool                                               IncludesMasterTeammatesSwitch;                            // 0x0890(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x3];                                       // 0x0891(0x0003) MISSED OFFSET
	float                                              MercenaryPerceptionDist;                                  // 0x0894(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              MasterPerceptionDist;                                     // 0x0898(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              UpdateMercenaryPlayerWhiteInterval;                       // 0x089C(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x50];                                      // 0x08A0(0x0050) UNKNOWN PROPERTY: SetProperty AI.MLAISubSystem.AICheckVisibilityFilteredActors
	TArray<TWeakObjectPtr<class UAIPerceptionDynamicItemComponent>> CachedDynamicItemComponents;                              // 0x08F0(0x0010) (ExportObject, ZeroConstructor)
	TArray<TWeakObjectPtr<class UAIPerceptionDynamicItemComponent>> CachedDestructibleItemComponents;                         // 0x0900(0x0010) (ExportObject, ZeroConstructor)
	unsigned char                                      UnknownData11[0x58];                                      // 0x0910(0x0058) MISSED OFFSET
	TMap<class AActor*, class ASpecialZoneActor*>      CacheSpecialZoneParents;                                  // 0x0968(0x0050) (ZeroConstructor)
	TArray<class ASpecialZoneActor*>                   CacheDynamicSpecialZone;                                  // 0x09B8(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData12[0x18];                                      // 0x09C8(0x0018) MISSED OFFSET
	class ABattleRoyaleGameMode*                       CurGameMode;                                              // 0x09E0(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData13[0x8];                                       // 0x09E8(0x0008) MISSED OFFSET
	class UDataTableProxy*                             ItemTable;                                                // 0x09F0(0x0008) (ZeroConstructor, IsPlainOldData)
	...
	void UnregisterSpecialMapping(const struct FString& Key);
	void UnregisterDynamicItemComponent(class UAIPerceptionDynamicItemComponent* InDynamicItemComp);
	void UnregisterDestructibleItemComponent(class UAIPerceptionDynamicItemComponent* InComp);
	void StartRequestCache();
	...
	void RegisterSpecialMapping(const struct FString& Key, int Value);
	void RegisterDynamicItemComponent(class UAIPerceptionDynamicItemComponent* InDynamicItemComp);
	void RegisterDestructibleItemComponent(class UAIPerceptionDynamicItemComponent* InComp);
...
{
public:
	float                                              SphereRadius;                                             // 0x0940(0x0004) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
