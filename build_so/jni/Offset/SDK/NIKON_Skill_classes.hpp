...
public:
	...
	uint64_t                                           NetClientSimulateInstID;                                  // 0x0F28(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData11[0x10];                                      // 0x0F30(0x0010) MISSED OFFSET
	struct FScriptMulticastDelegate                    CreativeSkillDelegate;                                    // 0x0F40(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
