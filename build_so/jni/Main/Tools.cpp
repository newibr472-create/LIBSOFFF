...
static ssize_t process_v(pid_t __pid, const struct iovec *__local_iov, unsigned long __local_iov_count,
...
bool Tools::IsPtrValid(void *addr) {
    if ((uintptr_t)addr < 0x1000) return false;
    uintptr_t p = 0;
