...
enum class ECharacterFitnessType : uint8_t
{
	...
	ECharacterFitnessType__ShooterLocationZ = 51,
	ECharacterFitnessType__ShooterAreaID = 52,
	ECharacterFitnessType__ShooterBaseIsMovable = 53,
	ECharacterFitnessType__ECharacterFitnessType_MAX = 54
};
...
enum class ECoronaClientData : uint8_t
{
	...
	ECoronaClientData__FireTimeID  = 17,
	ECoronaClientData__MaxAcceleration = 18,
	ECoronaClientData__ConfigCollisionDistSqAngle = 19,
	ECoronaClientData__ECoronaClientData_MAX = 20
};
