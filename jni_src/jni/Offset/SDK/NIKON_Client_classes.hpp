...
// Telegram:- @Manish8x
// GEN ONWed May 20 07:23:19 2026
...
public:
	...
	void Reprovide();
	void Pay(const struct FString& productid, const struct FString& InPayItem, const struct FString& Country, const struct FString& currency, const struct FString& InChannelExtras, const struct FString& InAppExtends, const struct FString& InPayChannel, const struct FString& InURL);
	...
	void GoodsPresent(const struct FString& productid, const struct FString& InPayItem, const struct FString& Price, const struct FString& Country, const struct FString& currency, const struct FString& MetaData, const struct FString& InChannelExtras, const struct FString& InAppExtends, const struct FString& InPayChannel, const struct FString& InURL);
	void Goods(const struct FString& productid, const struct FString& InPayItem, const struct FString& Price, const struct FString& Country, const struct FString& currency, const struct FString& InChannelExtras, const struct FString& InAppExtends, const struct FString& InPayChannel, const struct FString& InURL);
...
public:
	...
	struct FAnchors                                    DefaultAnchors;                                           // 0x0150(0x0010) (Transient)
	struct FVector2D                                   DefaultPosition;                                          // 0x0160(0x0008) (Transient, IsPlainOldData)
	int                                                CustomType;                                               // 0x0168(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData)
	float                                              Opacity;                                                  // 0x016C(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	bool                                               bInvalid;                                                 // 0x0170(0x0001) (BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData)
	...
	static UClass* StaticClass()
	{
        static UClass *pStaticClass = 0;
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("Class Client.CustomizePanel");
		return pStaticClass;
	}
	...
	void SetInterceptChildInput(bool bInInterceptChildInput);
	...
	void ApplyLayoutDataSimple(const struct FUIElemLayoutSimple& LayoutDetail);
...
public:
	...
	void CacheDefaultLayout(int InCustomType, const struct FAnchorData& AnchorData);
...
public:
	...
	unsigned char                                      UnknownData19[0x18];                                      // 0x05D0(0x0018) MISSED OFFSET
	float                                              PingReportInterval;                                       // 0x05E8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData20[0x10C];                                     // 0x05EC(0x010C) MISSED OFFSET
	int64_t                                            DeactivatedThreshold;                                     // 0x06F8(0x0008) (ZeroConstructor, Config, IsPlainOldData)
	int64_t                                            TimePassThreshold;                                        // 0x0700(0x0008) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ImageDownloadClearDayCount;                               // 0x0708(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData21[0x4];                                       // 0x070C(0x0004) MISSED OFFSET
	struct FScriptMulticastDelegate                    UIStackChangeDelegate;                                    // 0x0710(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    UIStackRecoverDelegate;                                   // 0x0720(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnFRefreshAdaptationUIEvent;                              // 0x0730(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnFRefreshAdaptationExUIEvent;                            // 0x0740(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    EnterBattleStageDelegate;                                 // 0x0750(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptMulticastDelegate                    OnAfterInitedDolphinDelegate;                             // 0x0760(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnDolphinVersionInfoDelegate;                             // 0x0770(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnDolphinNoticeInstallApkDelegate;                        // 0x0780(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnDolphinProgressDelegate;                                // 0x0790(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnDolphinErrorDelegate;                                   // 0x07A0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnRepairOverMaxTimesDelegate;                             // 0x07B0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnUpdateFinishedDelegate;                                 // 0x07C0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnRestartGameDelegate;                                    // 0x07D0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnInitIMSDKEnvDelegate;                                   // 0x07E0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnGetEnableCDNGetVersionDelegate;                         // 0x07F0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnAfterLoadedEditorLoginDelegate;                         // 0x0800(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnClearUIBeforeReInitLuaStateDelegate;                    // 0x0810(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnInitStateDelegate;                                      // 0x0820(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnStartPufferUpdateDelegage;                              // 0x0830(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnGetUpdateStateCDNConfigUrlDelegate;                     // 0x0840(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnGetCDNUpdateInfoDelegate;                               // 0x0850(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnQuickLoginDelegate;                                     // 0x0860(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnGetRegionNoByCountryNoDelegate;                         // 0x0870(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnPhoneMailLoginCallbackDelegate;                         // 0x0880(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnLoginSDKCallbackDelegate;                               // 0x0890(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnFileModifiedDelegate;                                   // 0x08A0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnLauncherEventCallback;                                  // 0x08B0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData22[0xC8];                                      // 0x08C0(0x00C8) MISSED OFFSET
	class UImageDownloader*                            ImageDownloaderInGame;                                    // 0x0988(0x0008) (ZeroConstructor, IsPlainOldData)
	int                                                FpsForWindowClient;                                       // 0x0990(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData23[0x4];                                       // 0x0994(0x0004) MISSED OFFSET
	class UUDPPingCollector*                           UDPPingCollector;                                         // 0x0998(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               UIElemLayoutJsonConfigSwitch;                             // 0x09A0(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               NationAllSwitch;                                          // 0x09A1(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               NationBattleSwitch;                                       // 0x09A2(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               NationRankSwitch;                                         // 0x09A3(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               SelfieSwitch;                                             // 0x09A4(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               ReportBugSwitch;                                          // 0x09A5(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               FirstVoicePopupSwitch;                                    // 0x09A6(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               GDPRForbidVoiceSwitch;                                    // 0x09A7(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               GDPRSettingSwitch;                                        // 0x09A8(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData24[0x3];                                       // 0x09A9(0x0003) MISSED OFFSET
	int                                                GDPRUserType;                                             // 0x09AC(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bShouldShowAdaptTipInLobby;                               // 0x09B0(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData25[0x3];                                       // 0x09B1(0x0003) MISSED OFFSET
	float                                              fLaggingFPSDiffThreshold;                                 // 0x09B4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFPSDiffThresholdMin;                              // 0x09B8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFPSDiffThresholdMax;                              // 0x09BC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFrameTimeThreshold;                               // 0x09C0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFrameTimeThresholdMin;                            // 0x09C4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFrameTimeThresholdMax;                            // 0x09C8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fFPSReportInterval;                                       // 0x09CC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData26[0x10];                                      // 0x09D0(0x0010) MISSED OFFSET
	bool                                               bUnLoadNoGcPackage;                                       // 0x09E0(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData27[0x7];                                       // 0x09E1(0x0007) MISSED OFFSET
	TArray<class UPackage*>                            NoGcPackages;                                             // 0x09E8(0x0010) (ZeroConstructor)
	bool                                               bFlushAsyncLoadingBeforeGC;                               // 0x09F8(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnableJMLog;                                             // 0x09F9(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData28[0xB6];                                      // 0x09FA(0x00B6) MISSED OFFSET
	bool                                               bEnableH5Cache;                                           // 0x0AB0(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bCheckWorldNameForLoadConfig;                             // 0x0AB1(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData29[0x6];                                       // 0x0AB2(0x0006) MISSED OFFSET
	class UColorBlindnessMgr*                          ColorBlindnessMgrInstace;                                 // 0x0AB8(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<struct FNativeHUDTickContainer>             NativeHUDTickList;                                        // 0x0AC0(0x0010) (ZeroConstructor)
	bool                                               IsNativeHUDTickLock;                                      // 0x0AD0(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               IsShutDown;                                               // 0x0AD1(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData30[0x2];                                       // 0x0AD2(0x0002) MISSED OFFSET
	int                                                NativeHUDTickIndex;                                       // 0x0AD4(0x0004) (ZeroConstructor, IsPlainOldData)
	class UAsyncLoadHelper*                            AsyncLoadHelper;                                          // 0x0AD8(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FString                                     BattleUtilsClassName;                                     // 0x0AE0(0x0010) (ZeroConstructor, Config)
	class UBattleUtils*                                BattleUtils;                                              // 0x0AF0(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData31[0x8];                                       // 0x0AF8(0x0008) MISSED OFFSET
	struct FScriptDelegate                             OnImagePickDetectEvent;                                   // 0x0B00(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData32[0x4];                                       // 0x0AF8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnVideoPickEvent;                                         // 0x0B10(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData33[0x4];                                       // 0x0B10(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnPermissionResultEvent;                                  // 0x0B20(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData34[0x4];                                       // 0x0B20(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptMulticastDelegate                    OnDeviceRotationChangedEvent;                             // 0x0B30(0x0010) (ZeroConstructor, InstancedReference)
	struct FString                                     CurrentMapName;                                           // 0x0B40(0x0010) (ZeroConstructor)
...
public:
	...
	static int ReturnSplitLobbyPakFileList_LuaState();
...
{
public:
	int                                                MaskType;                                                 // 0x0298(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   MaskTransformPivot;                                       // 0x029C(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector2D                                   MaskTransformScale;                                       // 0x02A4(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              MaskTransformAngle;                                       // 0x02AC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          MaskMaterial;                                             // 0x02B0(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UTexture2D*                                  MaskTexture;                                              // 0x02B8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
// Class Client.PinchDragWidget
// 0x0048 (0x02A8 - 0x0260)
class UPinchDragWidget : public UUserWidget
{
public:
	struct FScriptDelegate                             OnDrag;                                                   // 0x0260(0x000C) (BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0260(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnPinch;                                                  // 0x0270(0x000C) (BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0270(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnRelease;                                                // 0x0280(0x000C) (BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0280(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData03[0x18];                                      // 0x0290(0x0018) MISSED OFFSET

	static UClass* StaticClass()
	{
        static UClass *pStaticClass = 0;
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("Class Client.PinchDragWidget");
		return pStaticClass;
	}
...
public:
	...
	struct FScriptDelegate                             OnMouseButtonUp;                                          // 0x0038(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0038(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnMouseButtonDown;                                        // 0x0048(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0048(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnMotionDetected;                                         // 0x0058(0x000C) (ZeroConstructor, InstancedReference)
...
public:
	...
	static bool WriteFileAtPath(const struct FString& FilePath, const struct FString& Content);
	...
	static void StopBluetoothMonitor();
	static void StartUIStat(const struct FString& UIName);
	...
	static void StartBluetoothMonitor(int DelayMs);
	...
	static bool OneUp_GLauncherSetLogger();
	static bool OneUp_GLauncherSetLauncherEventCallback();
	static void OneUp_GLauncherSendEditorHWND(const struct FString& HWNDStr);
	static bool OneUp_GLauncherInitialize(const struct FString& GameID, const struct FString& gameChannelId, const struct FString& launcherChannelId, const struct FString& Port, const struct FString& loginFrom);
	static bool OneUp_GLauncherGetMsdkWebTokenEncodeUrl();
	static bool OneUp_GLauncherGetLoginInfoJsonStr();
	static bool OneUp_GLauncherAsyncGetMsdkWebTokenEncodeUrl(const struct FString& URL);
	static bool OneUp_GLauncherAsyncGameEventNotify(const struct FString& Event_Code, const struct FString& Event_Msg);
	...
	static void MountDecompressedShaderLibrary(const struct FString& GroupName);
	static void MessageBoxExt(const struct FString& Caption, const struct FString& Text);
	static void MemOptSetGameState(int State);
	...
	static bool IsShowingWatermark();
	...
	static TArray<struct FString> GetSlateTouchDebugLogQueue();
	...
	static struct FString GetPureIOSTmpDirectory();
	static struct FString GetPureIOSLibraryDirectory();
	...
	static struct FString GetInternalFilesDir();
	...
	static void ForceDecompressShaderLibrary(const struct FString& GroupName);
	...
	static bool EnableShaderGroupAsync_New(const struct FString& GroupNames);
	...
	static void CrashSetUserId(const struct FString& UserId);
	...
	static void CrashReportLogInfo(const struct FString& MsgType, const struct FString& Info);
	...
	static bool CopyFile(const struct FString& SrcFullPath, const struct FString& DesFullPath);
	...
	static void ClearSlateTouchDebugLogQueue();
...
{
public:
	ESCPDisplayState                                   DisplayState;                                             // 0x0178(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0179(0x0007) MISSED OFFSET
	class UMaterialInterface*                          SelectedImageCircularFlashEffectMaterial;                 // 0x0180(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UMaterialInterface*                          SelectedImageSquareFlashEffectMaterial;                   // 0x0188(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x10];                                      // 0x0190(0x0010) MISSED OFFSET
	TMap<struct FString, TWeakObjectPtr<class UWidget>> WidgetPtrMap;                                             // 0x01A0(0x0050) (ExportObject, ZeroConstructor, Transient)
...
public:
	...
	struct FScriptDelegate                             GetUserSettingsDelegate;                                  // 0x01F0(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x01F0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData05[0xB0];                                      // 0x0270(0x00B0) MISSED OFFSET
	TMap<struct FString, bool>                         LanguageMap;                                              // 0x0320(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData06[0x8];                                       // 0x0370(0x0008) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             OnGetAccessTokenDelegate;                                 // 0x0048(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0048(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnDetectDelegate;                                         // 0x0058(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0058(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnTranslateDelegate;                                      // 0x0068(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0068(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData03[0x80];                                      // 0x0078(0x0080) MISSED OFFSET
...
public:
	...
	TArray<struct FSlateColor>                         ColorSwitchList;                                          // 0x01A0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                ActiveColorIndex;                                         // 0x01B0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x01B4(0x0004) MISSED OFFSET
	TArray<struct FString>                             ColorDesList;                                             // 0x01B8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	struct FLinearColor                                TextColor;                                                // 0x01C8(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	TEnumAsByte<enum ETextJustify>                     Justification;                                            // 0x01D8(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum ETextVerticalJustify>             TextVerticalJustification;                                // 0x01D9(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               AutoWrapText;                                             // 0x01DA(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x5];                                       // 0x01DB(0x0005) MISSED OFFSET
	struct FScrollBarStyle                             ScrollBarStyle;                                           // 0x01E0(0x0680) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FMargin                                     HScrollBarPadding;                                        // 0x0860(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, IsPlainOldData)
	struct FMargin                                     VScrollBarPadding;                                        // 0x0870(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, IsPlainOldData)
	float                                              WrapTextAt;                                               // 0x0880(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FMargin                                     Margin;                                                   // 0x0884(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	float                                              LineHeightPercentage;                                     // 0x0894(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FString                                     HyperlinkDecoratorTag;                                    // 0x0898(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	struct FString                                     HyperlinkCallBackFunctionName;                            // 0x08A8(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	struct FString                                     HyperlinkCallBackTableName;                               // 0x08B8(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	unsigned char                                      UnknownData06[0x270];                                     // 0x08C8(0x0270) MISSED OFFSET
	class UGameFrontendHUD*                            GameFrontendHUD;                                          // 0x0B38(0x0008) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FScriptDelegate                             OnMouseButtonDownEvent;                                   // 0x04E0(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x4];                                       // 0x04E0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	struct FScriptDelegate                             OnSTTReportCallback;                                      // 0x0050(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0034(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnRSTSCallback;                                           // 0x0060(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0060(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnRSTSSpeechToTextCallback;                               // 0x0070(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData04[0x4];                                       // 0x0070(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnRSTSSubtitleCallback;                                   // 0x0080(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData05[0x4];                                       // 0x0080(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnRSTSSubtitleASRStartCallback;                           // 0x0090(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData06[0x4];                                       // 0x0090(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnSessionForAIInfoCallback;                               // 0x00A0(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData07[0x4];                                       // 0x00A0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnEnableMagicVoiceCallback;                               // 0x00B0(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData08[0x4];                                       // 0x00B0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnEnableRecvMagicVoiceCallback;                           // 0x00C0(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData09[0x4];                                       // 0x00C0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnSpeechFileTranslateCallback;                            // 0x00D0(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData10[0x4];                                       // 0x00D0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnSpeechTranslateCallback;                                // 0x00E0(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData11[0x4];                                       // 0x00E0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData12[0x10];                                      // 0x00F0(0x0010) MISSED OFFSET
	struct FString                                     ServerInfo;                                               // 0x0100(0x0010) (ZeroConstructor, Config)
	uint32_t                                           openVoiceSDKLog;                                          // 0x0110(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           MicVolumeMUFactor;                                        // 0x0114(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           SpeekerVolumeMUFactor;                                    // 0x0118(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                RoomOperationTimeout;                                     // 0x011C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UGameFrontendHUD*                            GameFrontendHUD;                                          // 0x0120(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData13[0x70];                                      // 0x0128(0x0070) MISSED OFFSET
	struct FScriptDelegate                             OpenMicFail;                                              // 0x0198(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData14[0x4];                                       // 0x0128(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OpenMicSuccess;                                           // 0x01A8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData15[0x4];                                       // 0x01A8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             CloseMicFail;                                             // 0x01B8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData16[0x4];                                       // 0x01B8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             BeforeOperation;                                          // 0x01C8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData17[0x4];                                       // 0x01C8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             CloseMicSuccess;                                          // 0x01D8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData18[0x4];                                       // 0x01D8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OpenSpeakerFail;                                          // 0x01E8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData19[0x4];                                       // 0x01E8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OpenSpeakerSuccess;                                       // 0x01F8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData20[0x4];                                       // 0x01F8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             CloseSpeakerFail;                                         // 0x0208(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData21[0x4];                                       // 0x0208(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             CloseSpeakerSuccess;                                      // 0x0218(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData22[0x4];                                       // 0x0218(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             JoinRoomFail;                                             // 0x0228(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData23[0x4];                                       // 0x0228(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             JoinRoomNotify;                                           // 0x0238(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData24[0x4];                                       // 0x0238(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             QuitRoomNotify;                                           // 0x0248(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData25[0x4];                                       // 0x0248(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             JoinLbsRoomNotify;                                        // 0x0258(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData26[0x4];                                       // 0x0258(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             QuitLbsRoomNotify;                                        // 0x0268(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData27[0x4];                                       // 0x0268(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             RoomStatusUpdatedNotify;                                  // 0x0278(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData28[0x4];                                       // 0x0278(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             SetAppInfoSuccess;                                        // 0x0288(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData29[0x4];                                       // 0x0288(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             SetAppInfoFail;                                           // 0x0298(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData30[0x4];                                       // 0x0298(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             GetReconnectInfo;                                         // 0x02A8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData31[0x4];                                       // 0x02A8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             ImSpeakingNotify;                                         // 0x02B8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData32[0x4];                                       // 0x02B8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             TestMicFail;                                              // 0x02C8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData33[0x4];                                       // 0x02C8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             TestMicSuccess;                                           // 0x02D8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData34[0x4];                                       // 0x02D8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             QuitRoomFail;                                             // 0x02E8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData35[0x4];                                       // 0x02E8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             DownLoadFileNotify;                                       // 0x02F8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData36[0x4];                                       // 0x02F8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             UploadFileNotify;                                         // 0x0308(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData37[0x4];                                       // 0x0308(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnPlayRecordedFileNotify;                                 // 0x0318(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData38[0x4];                                       // 0x0318(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             KwsNotify;                                                // 0x0328(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData39[0x4];                                       // 0x0328(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             ApplyMessageKeyNotify;                                    // 0x0338(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData40[0x4];                                       // 0x0338(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             MemberIsSpeakingNotify;                                   // 0x0348(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData41[0x4];                                       // 0x0348(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             LbsMemberIsSpeakingNotify;                                // 0x0358(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData42[0x4];                                       // 0x0358(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnMuteSwitchResult;                                       // 0x0368(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData43[0x4];                                       // 0x0368(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             ReportVoiceTimeToServer;                                  // 0x0378(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData44[0x4];                                       // 0x0378(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             RecordSuccess;                                            // 0x0388(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData45[0x4];                                       // 0x0388(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             RecordFail;                                               // 0x0398(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData46[0x4];                                       // 0x0398(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             UploadSuccess;                                            // 0x03A8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData47[0x4];                                       // 0x03A8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             UploadFail;                                               // 0x03B8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData48[0x4];                                       // 0x03B8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             EnableRoomMicrophone;                                     // 0x03C8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData49[0x4];                                       // 0x03C8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             ExitInfectionGameMode;                                    // 0x03D8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData50[0x4];                                       // 0x03D8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             JoinInfectionGameMode;                                    // 0x03E8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData51[0x4];                                       // 0x03E8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             RequestPrivacyInSetting;                                  // 0x03F8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData52[0x4];                                       // 0x03F8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnReportPlayerCallback;                                   // 0x0408(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData53[0x4];                                       // 0x0408(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnVoiceSDKEvent;                                          // 0x0418(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData54[0x4];                                       // 0x0418(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             BeforeVoiceSDKInitDelegate;                               // 0x0428(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData55[0x4];                                       // 0x0428(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             AfterVoiceSDKInitDelegate;                                // 0x0438(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData56[0x4];                                       // 0x0438(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             AudioRouteChangedAfterSpeakerDelegate;                    // 0x0448(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData57[0x4];                                       // 0x0448(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             AudioSessionInterruptedDelegate;                          // 0x0458(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData58[0x4];                                       // 0x0458(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnRoomMemeberInfoDelegate;                                // 0x0468(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData59[0x4];                                       // 0x0468(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData60[0x88];                                      // 0x0478(0x0088) MISSED OFFSET
	struct FScriptDelegate                             OnDeliverDataCallback;                                    // 0x0500(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData61[0x4];                                       // 0x0478(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	int SpeechTranslate(const struct FString& InFileID, int InSrcLang, int InTargetLang, int InTransType, int InTimeoutMS);
	int SpeechFileTranslate(const struct FString& InFilePath, int InSrcLang, int InTargetLang, int InVoiceType, float InVoiceRate, float InVolume, int InTimeoutMS);
	...
	int RSTSSpeechToText(int InSrcLang, const struct FString& InExtraInfo, const struct FString& InRecordFilePath);
