...
{
public:
	struct FScriptDelegate                             OnGenerateSpawnLocationDelegate;                          // 0x00E0(0x000C) (ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             SupplySpawnSpeciesDelegate;                               // 0x00E8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData00[0x4];                                       // 0x00E8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
