...
public:
	...
	struct FScriptMulticastDelegate                    OnInstanceTakeRadialDamage;                               // 0x0D98(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0DA8(0x0008) MISSED OFFSET
