...
// ScriptStruct Creative.CreativeActorDataNode
// 0x0030
struct FCreativeActorDataNode
{
	uint32_t                                           DataHashKey;                                              // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	struct FCreativeInstanceDataContent                DataContent;                                              // 0x0008(0x0028)
};

// ScriptStruct Creative.CreativeActorReplicatNode
// 0x003C (0x0048 - 0x000C)
struct FCreativeActorReplicatNode : public FFastArraySerializerItem
{
	uint32_t                                           DataHashKey;                                              // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           ID;                                                       // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      Type;                                                     // 0x0014(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      Seq;                                                      // 0x0015(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0016(0x0002) MISSED OFFSET
	struct FCreativeActorDataNode                      DataNode;                                                 // 0x0018(0x0030) (RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
};

// ScriptStruct Creative.CreativeActorNodeContainer
// 0x0018 (0x00C8 - 0x00B0)
struct FCreativeActorNodeContainer : public FFastArraySerializer
{
	TArray<struct FCreativeActorReplicatNode>          Nodes;                                                    // 0x00B0(0x0010) (ZeroConstructor)
	class UCreativeActorDataManager*                   ActorDataManager;                                         // 0x00C0(0x0008) (ZeroConstructor, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
};
...
// ScriptStruct Creative.CreativeCustomUIReplicateNode
// 0x0034 (0x0040 - 0x000C)
struct FCreativeCustomUIReplicateNode : public FFastArraySerializerItem
{
	...
	struct FCreativeInstanceDataContent                DataContent;                                              // 0x0018(0x0028) (RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
};

// ScriptStruct Creative.CreativeCustomUIContainer
// 0x0018 (0x00C8 - 0x00B0)
struct FCreativeCustomUIContainer : public FFastArraySerializer
{
	TArray<struct FCreativeCustomUIReplicateNode>      Nodes;                                                    // 0x00B0(0x0010) (ZeroConstructor)
	class UCreativeCustomUIDataComponent*              Component;                                                // 0x00C0(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
};

// ScriptStruct Creative.CreativeCustomUIDataTransferNode
// 0x0018
struct FCreativeCustomUIDataTransferNode
{
	uint32_t                                           ID;                                                       // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	TArray<unsigned char>                              Content;                                                  // 0x0008(0x0010) (ZeroConstructor)
};
...
struct FCreativeGameParameter : public FFastArraySerializerItem
{
	...
	bool                                               IsDiffContent;                                            // 0x0064(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FCreativeGameParameterResumeContainer : public FFastArraySerializer
{
	...
	class UCreativeGameParameterManager*               GameParameterManager;                                     // 0x0110(0x0008) (ZeroConstructor, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
};
