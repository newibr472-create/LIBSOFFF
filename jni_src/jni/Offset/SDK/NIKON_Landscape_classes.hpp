...
public:
	...
	struct FBoxSphereBounds                            LocalBounds;                                              // 0x09A8(0x001C) (IsPlainOldData)
	unsigned char                                      UnknownData01[0xC];                                       // 0x09C4(0x000C) MISSED OFFSET
...
// 0x0410 (0x0D50 - 0x0940)
class ULandscapeComponent : public UPrimitiveComponent
{
public:
	int                                                SectionBaseX;                                             // 0x0940(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData)
	int                                                SectionBaseY;                                             // 0x0944(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData)
	int                                                ComponentSizeQuads;                                       // 0x0948(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SubsectionSizeQuads;                                      // 0x094C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                NumSubsections;                                           // 0x0950(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bSubSectionRenderMaskComp : 1;                            // 0x0954(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      SubSectionRenderMaskComp;                                 // 0x0955(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0956(0x0002) MISSED OFFSET
	class UMaterialInterface*                          OverrideMaterial;                                         // 0x0958(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          OverrideHoleMaterial;                                     // 0x0960(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TMap<struct FName, class UMaterialInterface*>      OverrideOtherMaterials;                                   // 0x0968(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
	struct FOverridePhyxMaterial                       OverridePhyxMaterial;                                     // 0x09B8(0x0020) (Edit)
	unsigned char                                      bOverrideGrassTypes : 1;                                  // 0x09D8(0x0001) (Edit)
	unsigned char                                      UnknownData01[0x7];                                       // 0x09D9(0x0007) MISSED OFFSET
	TArray<class ULandscapeGrassType*>                 GrassTypes;                                               // 0x09E0(0x0010) (Edit, ZeroConstructor)
	TArray<class UMaterialInstanceConstant*>           MaterialInstances;                                        // 0x09F0(0x0010) (ZeroConstructor)
	TMap<struct FName, class UMaterialInstanceConstant*> OtherMaterialInstances;                                   // 0x0A00(0x0050) (ZeroConstructor)
	TArray<struct FWeightmapLayerAllocationInfo>       WeightmapLayerAllocations;                                // 0x0A50(0x0010) (ZeroConstructor)
	TArray<class UTexture2D*>                          WeightmapTextures;                                        // 0x0A60(0x0010) (ZeroConstructor)
	int                                                VisibilityLayerChannel;                                   // 0x0A70(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0A74(0x0004) MISSED OFFSET
	class UTexture2D*                                  XYOffsetmapTexture;                                       // 0x0A78(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FVector4                                    WeightmapScaleBias;                                       // 0x0A80(0x0010) (IsPlainOldData)
	float                                              WeightmapSubsectionOffset;                                // 0x0A90(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0xC];                                       // 0x0A94(0x000C) MISSED OFFSET
	struct FVector4                                    HeightmapScaleBias;                                       // 0x0AA0(0x0010) (IsPlainOldData)
	class UTexture2D*                                  HeightmapTexture;                                         // 0x0AB0(0x0008) (ZeroConstructor, IsPlainOldData)
	TMap<struct FString, struct FVisibilityData>       MultiVisibilityTextureData;                               // 0x0AB8(0x0050) (ZeroConstructor)
	struct FString                                     VisibleVisibilityLayer;                                   // 0x0B08(0x0010) (ZeroConstructor)
	struct FBox                                        CachedLocalBox;                                           // 0x0B18(0x001C) (IsPlainOldData)
	unsigned char                                      bUseCachedSectionLocalBoxs : 1;                           // 0x0B34(0x0001)
	unsigned char                                      UnknownData04[0x3];                                       // 0x0B35(0x0003) MISSED OFFSET
	TArray<float>                                      CachedSectionLocalBoxsHeight;                             // 0x0B38(0x0010) (ZeroConstructor)
	TLazyObjectPtr<class ULandscapeHeightfieldCollisionComponent> CollisionComponent;                                       // 0x0B48(0x001C) (ExportObject, InstancedReference, IsPlainOldData)
	struct FGuid                                       MapBuildDataId;                                           // 0x0B64(0x0010) (IsPlainOldData)
	unsigned char                                      UnknownData05[0x4];                                       // 0x0B74(0x0004) MISSED OFFSET
	TArray<struct FGuid>                               IrrelevantLights;                                         // 0x0B78(0x0010) (ZeroConstructor, Deprecated)
	int                                                CollisionMipLevel;                                        // 0x0B88(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                SimpleCollisionMipLevel;                                  // 0x0B8C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              NegativeZBoundsExtension;                                 // 0x0B90(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              PositiveZBoundsExtension;                                 // 0x0B94(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              StaticLightingResolution;                                 // 0x0B98(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                ForcedLOD;                                                // 0x0B9C(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	int                                                LODBias;                                                  // 0x0BA0(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	int                                                MobileVertexHoleMaxLOD;                                   // 0x0BA4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x10];                                      // 0x0BA8(0x0010) MISSED OFFSET
	TArray<float>                                      LODDeltaVertex;                                           // 0x0BB8(0x0010) (ZeroConstructor)
	float                                              MaxDeltaVertex;                                           // 0x0BC8(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FGuid                                       stateID;                                                  // 0x0BCC(0x0010) (IsPlainOldData)
	struct FGuid                                       BakedTextureMaterialGuid;                                 // 0x0BDC(0x0010) (IsPlainOldData)
	unsigned char                                      UnknownData07[0x4];                                       // 0x0BEC(0x0004) MISSED OFFSET
	class UTexture2D*                                  GIBakedBaseColorTexture;                                  // 0x0BF0(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData)
	struct FString                                     OccluderMeshDataPath;                                     // 0x0BF8(0x0010) (Edit, ZeroConstructor)
	unsigned char                                      MobileBlendableLayerMask;                                 // 0x0C08(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x7];                                       // 0x0C09(0x0007) MISSED OFFSET
	class UMaterialInterface*                          MobileMaterialInterface;                                  // 0x0C10(0x0008) (ZeroConstructor, IsPlainOldData)
	TMap<struct FName, class UMaterialInterface*>      OtherMobileMaterialInterfaces;                            // 0x0C18(0x0050) (ZeroConstructor)
	TArray<class UTexture2D*>                          MobileWeightmapTextures;                                  // 0x0C68(0x0010) (ZeroConstructor)
	class UTexture2D*                                  MobileWeightNormalmapTexture;                             // 0x0C78(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bMobileMultiLayers : 1;                                   // 0x0C80(0x0001)
	unsigned char                                      UnknownData09[0x7];                                       // 0x0C81(0x0007) MISSED OFFSET
	TArray<uint16_t>                                   CachedHeightData;                                         // 0x0C88(0x0010) (ZeroConstructor)
	bool                                               bUseLandscapeVT;                                          // 0x0C98(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bLandscapeVTNeedHeightmap;                                // 0x0C99(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x76];                                      // 0x0C9A(0x0076) MISSED OFFSET
	bool                                               bHasROCData;                                              // 0x0D10(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData11[0x1F];                                      // 0x0D11(0x001F) MISSED OFFSET
	struct FName                                       UsedOtherMaterialName;                                    // 0x0D30(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0x18];                                      // 0x0D38(0x0018) MISSED OFFSET
...
{
public:
	TArray<class ULandscapeLayerInfoObject*>           ComponentLayerInfos;                                      // 0x0940(0x0010) (ZeroConstructor)
	int                                                SectionBaseX;                                             // 0x0950(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SectionBaseY;                                             // 0x0954(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                CollisionSizeQuads;                                       // 0x0958(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              CollisionScale;                                           // 0x095C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SimpleCollisionSizeQuads;                                 // 0x0960(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0964(0x0004) MISSED OFFSET
	TArray<unsigned char>                              CollisionQuadFlags;                                       // 0x0968(0x0010) (ZeroConstructor)
	struct FGuid                                       HeightfieldGuid;                                          // 0x0978(0x0010) (IsPlainOldData)
	struct FBox                                        CachedLocalBox;                                           // 0x0988(0x001C) (IsPlainOldData)
	TLazyObjectPtr<class ULandscapeComponent>          RenderComponent;                                          // 0x09A4(0x001C) (ExportObject, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData01[0x10];                                      // 0x09C0(0x0010) MISSED OFFSET
	TArray<class UPhysicalMaterial*>                   CookedPhysicalMaterials;                                  // 0x09D0(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x40];                                      // 0x09E0(0x0040) MISSED OFFSET
...
{
public:
	struct FGuid                                       MeshGuid;                                                 // 0x0A20(0x0010) (IsPlainOldData)
...
public:
	...
	TArray<struct FIntPoint>                           ProxyComponentBases;                                      // 0x0B58(0x0010) (ZeroConstructor)
	int8_t                                             ProxyLOD;                                                 // 0x0B68(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
public:
	TArray<class ULandscapeSplineControlPoint*>        ControlPoints;                                            // 0x0940(0x0010) (ZeroConstructor)
	TArray<class ULandscapeSplineSegment*>             Segments;                                                 // 0x0950(0x0010) (ZeroConstructor)
	TArray<class UMeshComponent*>                      CookedForeignMeshComponents;                              // 0x0960(0x0010) (ExportObject, ZeroConstructor)
